...
>
> Not built yet: module / course completion rollups (rest of EP-06), remaining EP-08 admin stories (Manage Users, Manage Categories, Monitor Platform Health). US-08-03 (admin instructor-application review) is shipped. EP-07 (Instructor Dashboard) is fully shipped. `docs/USER_GUIDE.md` is the authoritative end-to-end feature matrix.
